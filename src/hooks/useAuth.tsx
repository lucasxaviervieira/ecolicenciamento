 ...
 * @param - O código fornecido é um componente funcional React chamado `AuthProvider` que serve como
...
export const AuthProvider: React.FC<{ children: React.ReactNode }> = ({
   ...
   * @param {User} data - O parâmetro `data` na função `login` é do tipo `User`, que contém informações
