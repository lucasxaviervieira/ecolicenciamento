    ...
    <AuthProvider>
      <Routes>
        ...
        */}
        ...
        <Route path="/" element={<RouteIsAuth>
        ...
        <Route path="/licenciamento" element={<ProtectedRoute>
          <PageTitle title="GQM - Licenciamento" />
          <Navbar />
          <Datatable />
        </ProtectedRoute>} />
        <Route path="/adicionar" element={<ProtectedRoute>
          <PageTitle title="GQM - Adicionar" />
          <Navbar />
          <LicenseRegister />
        </ProtectedRoute>} />
        <Route path="/remover" element={<ProtectedRoute>
          <PageTitle title="GQM - Remover" />
          <Navbar />
          <RemoveLicense />
        </ProtectedRoute>} />
        <Route path="/dashboard_gestao" element={<ProtectedRoute>
          <PageTitle title="GQM - Dashboard Gestão" />
          <Navbar />
          <DashboardGestor />
        </ProtectedRoute>} />
        <Route path="/dashboard_monitor" element={<ProtectedRoute>
          <PageTitle title="GQM - Dashboard Monitor" />
          <Navbar />
          <DashboardMonitor />
        </ProtectedRoute>} />
        <Route path="/dashboard_operacao" element={<ProtectedRoute>
        ...
        <Route path="/observacoes/:observacoesId" element={<ProtectedRoute>
          <PageTitle title="GQM - Observação" />
          <Navbar />
          <Observation />
        </ProtectedRoute>} />
        <Route path="/agenda/:agendaId" element={<ProtectedRoute>
