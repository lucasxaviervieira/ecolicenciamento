...
export default function Observation() {
  const [data, setData] = useState<Observations[]>(LoadingObservations);
  ...
  function isData(myData: boolean) {
        ...
        <div className="h-full w-[95%] overflow-auto">
          <div className="relative w-full max-w-none h-auto text-sm">
            ...
            <div
              ...
              className="hidden divide-y divide-gray-200"
            >
              {data.map((row: Observations) => {
                return (
                  <>
                    <div
