...
export default function DashboardMonitor() {
    ...
    return (<>
      <div className="hidden fixed w-full h-[88%] pt-3" id="loading-datatable">
        <iframe title="Dashboard Novo" onLoad={handleIframeLoad} src="https://app.powerbi.com/view?r=eyJrIjoiMTNkMjEyNTQtZTdjOC00ZDkzLWFhMDItMGNiMWQ2NDEzOWU0IiwidCI6IjFjMDMzNzc4LTU4MWItNDAwYy05NDM3LWM5MjI1Y2VmZWQ3MCJ9" className="w-full h-full"></iframe>
      </div>
      {isIframeLoaded ? (<>
          {document
