        ...
        <div className="hidden md:ml-6 md:block">
          <div className="flex items-center sm:space-x-1 2xl:space-x-4">
            <NavLink className={({ isActive }) => isActive
              ...
              : "inline-flex gap-x-1 items-center hover:bg-gray-200 text-black rounded-md lg:px-2 lg:py-1 2xl:px-3 xl:py-2 text-sm text-center font-medium"} to="/licenciamento">
              Licenciamento
            ...
            <NavLink className={({ isActive }) => isActive
              ...
              : "inline-flex gap-x-1 items-center hover:bg-gray-200 text-black rounded-md lg:px-2 lg:py-1 2xl:px-3 xl:py-2 text-sm text-center font-medium"} to="/adicionar">
              Adicionar Licença
              <div className="hidden xl:block">
                <AddLicense />
              </div>
            ...
            <NavLink className={({ isActive }) => isActive
              ...
              : "inline-flex gap-x-1 items-center hover:bg-gray-200 text-black rounded-md lg:px-2 lg:py-1 2xl:px-3 xl:py-2 text-sm text-center font-medium"} to="/dashboard_gestao">
              Dashboard (Gestão)
              <div className="hidden xl:block">
                <DashGestor />
              </div>
            ...
            <Menu as="div" className="relative inline-block text-left px-3 py-0.5">
              <div>
              ...
              <Transition as={Fragment} enter="transition ease-out duration-100" enterFrom="transform opacity-0 scale-95" enterTo="transform opacity-100 scale-100" leave="transition ease-in duration-75" leaveFrom="transform opacity-100 scale-100" leaveTo="transform opacity-0 scale-95">
                <Menu.Items className="overflow-auto absolute right-0 z-40 mt-2 w-56 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                  ...
                  <Menu.Item>
                    <Link to="/painel" className="block w-full px-4 py-2 text-left text-sm hover:bg-gray-100">
                      <div className="inline-flex justify-center items-center gap-x-2">
                        <CheckListIcon />
                  ...
                  <Menu.Item>
                    <button onClick={handleLogout} className="block w-full px-4 py-2 text-left text-sm hover:bg-gray-100">
                      <div className="inline-flex justify-center items-center gap-x-2">
                        <LogoutIcon />
