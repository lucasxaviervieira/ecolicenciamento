...
export default function Datatable() {
  ...
  const wasSubmited = (submitedTimes: SetStateAction<number>) => {
  ...
  */
  ...
  return (
    <>
        ...
        <div className="grow inline-flex gap-x-3 items-center">
          ...
          <div>
            <p className="inline-flex gap-x-1.5 justify-center rounded-md bg-white px-3 py-2 text-xs md:text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50">
              Total de Licenças:{" "}
              <LoadingItem
                delay={delayToLoadPage}
                loadingIcon={
                  <LoadingIcon
                    iconParams={{ color: "fill-blue-500", size: "sm" }}
                  />
                }
              />
      ...
      />
      <div
        className="hidden p-5 max-h-[80%] flex flex-col justify-center items-center"
              ...
              {table.getHeaderGroups().map((headerGroup) => (
                <tr key={headerGroup.id}>
                  {headerGroup.headers.map((header) => {
                    ...
                    const element =
                      header.id == "button" || header.id == "agenda"
                        ? elementWithoutFilter
                        : elementWithFilter;
                    ...
                    const classNameText =
                      header.id == "button" ? buttonClassName : className;
