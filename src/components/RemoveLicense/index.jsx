        ...
        <form className="bg-gray-50" onSubmit={handleSubmit}>
          <div className="px-8 pt-4 text-gray text-center">
            <div className="col-span-6 md:col-span-2">
              ...
              <input className="p-3 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" id="area" type="number" ref={removeRef} required />
